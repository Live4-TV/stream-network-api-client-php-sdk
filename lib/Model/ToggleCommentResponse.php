...
/**
 * ToggleCommentResponse Class Doc Comment
 *
 * @category Class
 * @package  StreamNetworkApi
 * @author   OpenAPI Generator team
 ...
 */
class ToggleCommentResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ToggleCommentResponse';
    ...
    */
     ...
     * Sets accounts
     *
     * @param \StreamNetworkApi\Model\StopLiveDetailsResponse[] $accounts An list of responses for each account, with the comment status
     *
     * @return self
     */
