...
/**
 * SocialNetworkAccount Class Doc Comment
 *
 * @category Class
 * @package  StreamNetworkApi
 * @author   OpenAPI Generator team
 ...
 */
class SocialNetworkAccount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SocialNetworkAccount';
    ...
    */
     ...
     * Sets uuid
     *
     * @param string $uuid The unique identifier for the account
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string $name The displayable integration for the account
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string $type The social network of the account
     *
     * @return self
     */
