...
/**
 * StartListeningToCommentsRequest Class Doc Comment
 *
 * @category Class
 * @package  StreamNetworkApi
 * @author   OpenAPI Generator team
 ...
 */
class StartListeningToCommentsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StartListeningToCommentsRequest';
    ...
    */
     ...
     * Sets accounts
     *
     * @param string[] $accounts An array of social network tokens to create the live stream (the value we return after the login) IMPORTANT! All tokens must be from the same user (userExternalId)
     *
     * @return self
     */
