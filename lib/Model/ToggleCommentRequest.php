...
/**
 * ToggleCommentRequest Class Doc Comment
 *
 * @category Class
 * @package  StreamNetworkApi
 * @author   OpenAPI Generator team
 ...
 */
class ToggleCommentRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ToggleCommentRequest';
    ...
    */
     ...
     * Sets accounts
     *
     * @param string[]|null $accounts The unique identifier for the specific social network account stream, if not provided, the comment will be toggled for all accounts
     *
     * @return self
     */
