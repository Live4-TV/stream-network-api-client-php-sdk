...
/**
 * CreateAndStartLiveAccountDetailsResponse Class Doc Comment
 *
 * @category Class
 * @package  StreamNetworkApi
 * @author   OpenAPI Generator team
 ...
 */
class CreateAndStartLiveAccountDetailsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateAndStartLiveAccountDetailsResponse';
    ...
    */
     ...
     * Sets uuid
     *
     * @param string $uuid The unique identifier for the specific social network account stream
     *
     * @return self
     */
     ...
     * Sets stream_url
     *
     * @param string $stream_url The stream url to use in the OBS
     *
     * @return self
     */
     ...
     * Sets stream_key
     *
     * @param string $stream_key The stream key to use in the OBS
     *
     * @return self
     */
     ...
     * Sets code
     *
     * @param float $code The code of response, 200 for success, 401 for authentication error
     *
     * @return self
     */
     ...
     * Sets message
     *
     * @param string $message The string message of the error
     *
     * @return self
     */
