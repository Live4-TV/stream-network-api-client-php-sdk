...
/**
 * GetAuthoriseUrlRequest Class Doc Comment
 *
 * @category Class
 * @package  StreamNetworkApi
 * @author   OpenAPI Generator team
 ...
 */
class GetAuthoriseUrlRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetAuthoriseUrlRequest';
    ...
    {
        $this->setIfExists('user_external_id', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['user_external_id'] === null) {
            $invalidProperties[] = "'user_external_id' can't be null";
        }
     ...
     *
     * @param string $user_external_id The user's unique identifier on your system. This is what you will use to identify the user in future requests.
     *
     * @return self
     */
    public function setUserExternalId($user_external_id)
    {
        if (is_null($user_external_id)) {
            throw new \InvalidArgumentException('non-nullable user_external_id cannot be null');
        }
     ...
     * Sets account_uuid
     *
     * @param string $account_uuid The reference to the new account that you can use to identify the account in future requests
     *
     * @return self
     */
