...
/**
 * StopListeningToCommentsRequest Class Doc Comment
 *
 * @category Class
 * @package  StreamNetworkApi
 * @author   OpenAPI Generator team
 ...
 */
class StopListeningToCommentsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StopListeningToCommentsRequest';
    ...
    */
     ...
     * Sets accounts
     *
     * @param string[] $accounts An array of social network tokens to create the live stream (the value we return after the login)
     *
     * @return self
     */
